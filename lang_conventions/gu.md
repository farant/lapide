...
- **False-cognate translation traps** (locked from review of `01_Preliminares_gu.html`):
  ...
  - "Barbarica lingua" (Basil's literary self-deprecation, "unpolished tongue") → use અસંસ્કૃત ભાષા; બર્બર is too pejorative for the literary sense (though acceptable for genuinely uncivilized behavior).
