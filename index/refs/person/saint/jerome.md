...
related:
  people:
    ...
    - person/pope/gregory-i
    - person/saint/isidore-of-seville
  ...
  works:
    ...
    - bibliography/jerome/psalter
    - bibliography/jerome/prophets-translation
  subjects:
...
- `01_Preliminares.html#preface-reader-p3-s-70edd26` — Testified that in his time there were as many copies as manuscripts, each person adding or subtracting at whim
  text: "St. Jerome testified occurred in his time: namely, there were as many copies as there were manuscripts"
- `01_Preliminares.html#preface-reader-p4-s-478c02e` — The Old and Vulgate edition received in part from his translation or emendation; he called the older edition the "Common and Vulgate"
...
- `01_Preliminares.html#preface-reader-p6-s-5ee3ad6` — Augustine called him most learned and skilled in three languages; Gregory praised his translation as rendering everything more truly from Hebrew; Isidore preferred his version; Sophronius translated his Psalter and Prophets into Greek
  text: "St. Augustine calls him a most learned man and most skilled in three languages"
- `01_Preliminares.html#preface-reader-p7-s-0d3b6b4` — Later scholars (Remigius, Bede, Rabanus, etc.) used his version so exclusively that other versions became obsolete
...
- `01_Preliminares.html#preface-reader-p8-s-01e6328` — Celebrated by the Catholic Church as the greatest Doctor raised up for interpretation of sacred Scriptures
...
- `01_Preliminares.html#preface-reader-p14-s-5d5d3a9` — More than once warned against changing readings to avoid offending the people
  text: "St. Jerome more than once warned that this should be done, to avoid offending the people"
- `01_Preliminares.html#life-p2-s-39bff91` — Listed among saints whose company Lapide found in Rome; his "holy Bethlehem" sought in Palestine, found in Rome
...
- `02_Clemens_Hieronymi_Du_Culte.html#helmeted-prologue-s-7203168` — Heading identifies him as author of the Helmeted Prologue
  text: "THE HELMETED PROLOGUE."
- `02_Clemens_Hieronymi_Du_Culte.html#helmeted-prologue-p29-s-33e0737` — Speaking in the first person, defends his translation labor; asks readers not to consider his work a reproach of the ancients; invokes the handmaids of Christ to pray for him against detractors
...
- `02_Clemens_Hieronymi_Du_Culte.html#jerome-to-paulinus-s-170187d` — Heading identifies him as author of the letter to Paulinus
  text: "JEROME TO PAULINUS."
- `02_Clemens_Hieronymi_Du_Culte.html#jerome-to-paulinus-p2-s-318a2be` — Speaks in first person throughout; recounts examples of seekers of learning (Pythagoras, Plato, Apollonius); writes to Paulinus about the study of Scripture
