...
- `01_Preliminares.html#preface-reader-p3-s-fab5457` — Testified that in his time there were as many copies as manuscripts, each person adding or subtracting at whim
  text: "St. Jerome testified occurred in his time: namely, there were as many copies as there were manuscripts"
- `01_Preliminares.html#preface-reader-p4-s-8dfb7da` — The Old and Vulgate edition received in part from his translation or emendation; he called the older edition the "Common and Vulgate"
...
- `01_Preliminares.html#preface-reader-p6-s-243ce1b` — Augustine called him most learned and skilled in three languages; Gregory praised his translation as rendering everything more truly from Hebrew; Isidore preferred his version; Sophronius translated his Psalter and Prophets into Greek
  text: "St. Augustine calls him a most learned man and most skilled in three languages"
- `01_Preliminares.html#preface-reader-p7-s-a8f0aed` — Later scholars (Remigius, Bede, Rabanus, etc.) used his version so exclusively that other versions became obsolete
...
- `01_Preliminares.html#preface-reader-p8-s-acb6948` — Celebrated by the Catholic Church as the greatest Doctor raised up for interpretation of sacred Scriptures
...
- `01_Preliminares.html#preface-reader-p14-s-955dfa3` — More than once warned against changing readings to avoid offending the people
