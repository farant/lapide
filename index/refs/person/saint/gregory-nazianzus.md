...
slug: person/saint/gregory-nazianzus
category: person
subcategory: saint
also_known_as:
...
related:
  ...
  places:
    ...
    - place/middle-east/turkey/nazianzus
  organizations: []
  works:
    - bibliography/gregory-nazianzen/oration-in-praise-of-basil
  subjects:
    - subject/church-fathers
    - subject/friendship/basil-and-gregory
---
...
- `01_Preliminares.html#dedicatory-letter-p8-s-63c60bc` — Called "peer" of Basil; authored Oration in Praise of Saint Basil; called Basil "the Moses of his age"
...
- `01_Preliminares.html#dedicatory-letter-p27-s-90d273d` — Said "the life of Basil was for all a rule of living"
  text: "what Gregory Nazianzen says of Saint Basil — 'the life of Basil was for all a rule of living'"
- `01_Preliminares.html#dedicatory-letter-p30-s-f3b3289` — Testifies about Modestus pressing Basil; records the dialogue between Basil and the Prefect
  text: "Modestus, the Prefect of Valens, as Gregory Nazianzen testifies, pressed Basil to follow the religion of the Emperor."
- `01_Preliminares.html#dedicatory-letter-p36-s-0facef2` — Writes about crowds at Basil's funeral
