...
- `01_Preliminares.html#trent-decrees-p6-s-b82ae87` — Two epistles of Peter listed in the canon
  text: "two of Peter the Apostle"
- `02_Clemens_Hieronymi_Du_Culte.html#jerome-to-paulinus-p2-s-be0e41b` — Paul went to Jerusalem to see Peter and remained with him fifteen days
  text: "went up to Jerusalem to see Peter and remained with him fifteen days"
- `02_Clemens_Hieronymi_Du_Culte.html#jerome-to-paulinus-p2-s-441bb99` — The Pharisees marvel at Peter and John, how they know the law without having learned letters; Jerome asks whether Peter should be called a rustic
...
- `02_Clemens_Hieronymi_Du_Culte.html#du-culte-p8-s-b19f930` — Peter the fisherman, illuminated by the Holy Spirit, descends from the upper room and addresses the multitude
